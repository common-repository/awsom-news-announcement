...
<script type="text/javascript" src="<?php echo $awsomnews_path; ?>tinymce/tinymce.min.js"></script>
...
<div class="wrap" style="font-size:12pt;">
  ...
  <br />
    ...
    <h2>AWSOM News ver. 1.6.0 Administration Page</h2>
